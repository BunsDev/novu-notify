...
import {
  JsonSchemaFormat,
  JsonSchemaFormat$inboundSchema,
  JsonSchemaFormat$outboundSchema,
} from "./jsonschemaformat.js";
import {
  JsonSchemaType,
  JsonSchemaType$inboundSchema,
  JsonSchemaType$outboundSchema,
} from "./jsonschematype.js";
...
/** @internal */
export const Enum$inboundSchema: z.ZodType<Enum, z.ZodTypeDef, unknown> = z
  .object({});

/** @internal */
export type Enum$Outbound = {};

/** @internal */
export const Enum$outboundSchema: z.ZodType<Enum$Outbound, z.ZodTypeDef, Enum> =
  z.object({});
...
export namespace Enum$ {
  ...
  /** @deprecated use `Enum$Outbound` instead. */
  export type Outbound = Enum$Outbound;
}

export function enumToJSON(value: Enum): string {
  return JSON.stringify(Enum$outboundSchema.parse(value));
}

export function enumFromJSON(
  jsonString: string,
): SafeParseResult<Enum, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Enum$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Enum' from JSON`,
  );
}
...
export const JSONSchemaDto$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: JsonSchemaType$inboundSchema.optional(),
  format: JsonSchemaFormat$inboundSchema.optional(),
  title: z.string().optional(),
  description: z.string().optional(),
  default: z.lazy(() => Default$inboundSchema).optional(),
  ...
  enum: z.array(z.lazy(() => Enum$inboundSchema)).optional(),
...
export type JSONSchemaDto$Outbound = {
  ...
  title?: string | undefined;
  description?: string | undefined;
  default?: Default$Outbound | undefined;
  ...
  enum?: Array<Enum$Outbound> | undefined;
...
export const JSONSchemaDto$outboundSchema: z.ZodType<
  ...
  JSONSchemaDto
> = z.object({
  type: JsonSchemaType$outboundSchema.optional(),
  format: JsonSchemaFormat$outboundSchema.optional(),
  title: z.string().optional(),
  description: z.string().optional(),
  default: z.lazy(() => Default$outboundSchema).optional(),
  ...
  enum: z.array(z.lazy(() => Enum$outboundSchema)).optional(),
