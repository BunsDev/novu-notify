...
import {
  ControlsMetadata,
  ControlsMetadata$inboundSchema,
  ControlsMetadata$Outbound,
  ControlsMetadata$outboundSchema,
} from "./controlsmetadata.js";
import {
  JSONSchemaDto,
...
export const StepResponseDto$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  controls: ControlsMetadata$inboundSchema,
...
export type StepResponseDto$Outbound = {
  controls: ControlsMetadata$Outbound;
...
export const StepResponseDto$outboundSchema: z.ZodType<
  ...
  StepResponseDto
> = z.object({
  controls: ControlsMetadata$outboundSchema,
